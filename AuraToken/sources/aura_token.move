...
module admin_addr::aura_token {
    ...
    public fun get_metadata(): Object<Metadata> {
        let metadata_address = object::create_object_address(&@admin_addr, ASSET_SYMBOL);
    ...
    #[test(creator = @admin_addr, aaron = @0xface)]
    #[expected_failure(abort_code = 0x50001, location = admin_addr::managed_fungible_asset)]
